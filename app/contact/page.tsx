    ...
    return (
        <div className="flex flex-col text-center pt-16">
            ...
            <div className="flex justify-center space-x-4">
                ...
                <a href="https://twitter.com/likebeats" target="_blank">
                    <Image src={`${REPO_PREFIX}/images/twitter-icon.png`} alt="Twitter" width={40} height={40} />
                </a>
                <a href="https://angel.co/likebeats" target="_blank">
                    <Image src={`${REPO_PREFIX}/images/angel-list-icon.png`} alt="AngelList" width={40} height={40} />
                </a>
            </div>
        </div>
    );
